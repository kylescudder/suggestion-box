        ...
        <CardContent>
          {result?.success && (
            <div className="mb-6 p-4 bg-emerald-50 border border-emerald-200 rounded-lg flex items-center gap-3 animate-bounce-gentle animate-pulse-glow">
              ...
              <p className="text-emerald-700 font-medium magic-text">{result.success}</p>
            </div>
          )}
          ...
          <form id="suggestion-form" action={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="author_email" className="text-slate-700 font-medium">
                  Your email (optional)
                </Label>
                <Input
                  id="author_email"
