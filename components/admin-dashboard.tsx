...
import { Clock, Mail, User, Calendar, Sparkles, CheckCircle, XCircle, Eye } from "lucide-react"
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-blue-200 hover:shadow-lg transition-all duration-300">
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-slate-800">{statusCounts.reviewed}</p>
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-green-200 hover:shadow-lg transition-all duration-300">
          <CardContent className="p-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-slate-800">{statusCounts.implemented}</p>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border-emerald-200">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-slate-500">
                    {filter === "all" ? "No magical ideas have been submitted yet." : `No ${filter} suggestions found.`}
                  </p>
                </CardContent>
              </Card>
            ) : (
                    ...
                    <CardContent>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {updatingStatus === suggestion.id && (
                          <div className="text-sm text-emerald-600">Updating...</div>
                        )}
                      </div>
                    </CardContent>
                  </Card>
