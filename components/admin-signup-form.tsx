    ...
    <div className="w-full max-w-md">
      <Card className="bg-white/10 backdrop-blur-md border-emerald-300/30 shadow-2xl">
        <CardHeader className="text-center pb-6">
          ...
          <p className="text-emerald-200 mt-2">Create your magical admin account</p>
        </CardHeader>
        ...
        <CardContent>
          <form action={formAction} className="space-y-6">
            ...
            {state?.success && (
              <div className="bg-emerald-500/20 border border-emerald-400/50 text-emerald-200 px-4 py-3 rounded-lg">
                {state.success}
              </div>
            )}
            ...
            <div className="text-center text-emerald-200/80 text-sm">
              ...
              <Link href="/admin/login" className="text-emerald-300 hover:text-emerald-200 underline">
                Sign in here
              </Link>
            </div>
          </form>
