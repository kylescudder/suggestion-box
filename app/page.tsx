  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 relative overflow-hidden magic-particles">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute top-32 right-1/3 animate-float" style={{ animationDelay: "2.5s" }}>
          <Heart className="w-4 h-4 text-green-300 animate-twinkle" />
        </div>
        <div className="absolute bottom-40 left-1/2 animate-float" style={{ animationDelay: "3s" }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-12">
        ...
        <div className="mt-12 text-center animate-bounce-gentle" style={{ animationDelay: "1s" }}>
          <p className="text-slate-500 text-sm animate-twinkle">Every great idea starts with a single spark</p>
        </div>
      </div>
    </div>
  )
